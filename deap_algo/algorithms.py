...
def eaSimple(population, toolbox, cxpb, mutpb, ngen, nelite, stats=None,
    ...
    for gen in range(1, ngen + 1):
        ...
        elite = int((nelite/100.0) * len(offspring)) 
        #elite /= 1
        #print (elite)
        
        temp_offspring  = offspring[0:elite]
        #print temp_offspring[1].fitness.values
        ...
        sorted(offspring, key=attrgetter("fitness"), reverse=True)

        if len(last)!=0:
            
            for i in range(elite):
                if temp_offspring[i].fitness.values < last[i].fitness.values:
                    temp_offspring[i] = last[i]
        else :
            last = temp_offspring[0:elite]

        #last = temp_offspring[0:elite]
        for i in range(len(offspring)-elite, len(offspring)):
            offspring[i] = temp_offspring[i - (len(offspring)-elite)]
